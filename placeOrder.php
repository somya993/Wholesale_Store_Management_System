...
<?php
	...
	$totalPrice = (isset($_GET['totalPrice']) && is_numeric($_GET['totalPrice'])) ? $_GET['totalPrice'] : 0;
?>
<!DOCTYPE html>
<html>
<meta charset="utf-8">
...
<div class='container'>
	...
	<?php
		if(isset($_GET['submit'])){
			...
			$sql="insert into transactions(transaction_amount,customer_id,phone,address,payment,date) values('$totalPrice','$custID','$phone','$address','$payment',current_date())";
